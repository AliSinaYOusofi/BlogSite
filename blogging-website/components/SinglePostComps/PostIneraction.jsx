        ...
        <div className="w-[5%] text-white flex flex-col items-center justify-start
         gap-y-10 sticky top-0 h-full mt-10">
            ...
            <div onClick={handleLike} className="flex flex-col items-center " >
                <div ref={likesRef} className="mt-24 w-fit cursor-pointer bg-white text-black rounded-full p-3 transition-all duration-300 hover:-translate-y-[1px]">
                    <svg  className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
                    </svg>
                </div>
                <p className="mx-auto text-black">{likes}</p>
            </div>

            <div className="flex flex-col items-center ">
                <div className="w-fit cursor-pointer bg-white text-black rounded-full p-3 transition-all duration-300 hover:-translate-y-[1px]">
            ...
            <div className="cursor-pointer bg-white text-black rounded-full p-3 transition-all duration-300 hover:-translate-y-[1px]">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17.593 3.322c1.1.128 1.907 1.077 1.907 2.185V21L12 17.25 4.5 21V5.507c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0111.186 0z" />
                </svg>
            </div>
            
            <div onClick={copyToClipboard} className="cursor-pointer bg-white text-black rounded-full p-3 transition-all duration-300 hover:-translate-y-[1px]">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
