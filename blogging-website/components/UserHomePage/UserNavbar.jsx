                ...
                <div className="flex items-center md:order-2 group relative">
                    ...
                    <div className="z-50 rounded-md hidden right-6 top-6 absolute group-hover:block  my-4 text-base list-none bg-[#FDF8F5]" id="user-dropdown">
                        ...
                        <ul className="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500">
                            ...
                            <li className="mr-2">
                                <Link href={{pathname: "/all_posts", query: {"user": token}}} className="inline-flex p-4 transition-all duration-300 hover:translate-x-1 rounded-t-lg  group" aria-current="page">
                            ...
                            <li className="mr-2">
                                <Link href={{pathname: "/make_post", query: token}} className="inline-flex p-4 rounded-t-lg group transition-all duration-300 hover:translate-x-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
