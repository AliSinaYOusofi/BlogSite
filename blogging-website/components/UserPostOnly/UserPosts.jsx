    ...
    return (
        <div className="max-w-2xl px-8 py-4 mx-auto  rounded-lg shadow-md bg-[#d1d3ce] mt-10" key={id}>
            <div className="flex items-center justify-between">
                <span className="text-sm font-light text-white">{date ? date.split("T")[0] : ""}</span> 
            </div> 
            <div className="mt-2">
            ...
            <div className="flex items-center justify-between mt-4">
                <Link href={{ pathname:"/single_post_view", query: {post: id} }} className="text-[blue] transition-all duration-300 hover:underline" id={id}>Read more ⟶</Link> 
