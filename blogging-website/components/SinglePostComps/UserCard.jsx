    ...
    return (
        <address className="flex items-center mb-6 not-italic rounded-md">
            <div className="inline-flex justify-center  p-4 items-center mr-3 text-sm text-gray-900 dark:text-white">
                ...
                <div>
                    <a href="#" rel="author" className="text-xl font-bold text-gray-900 dark:text-white">{dataUsername || "username"}</a>
                    <p className="text-base font-light text-gray-500 dark:text-gray-400">{dataEmail || "email@domain.com"}</p>
                    <p className="text-base font-light text-gray-500 dark:text-gray-400"><time pubdate datetime="2022-02-08" title="February 8th, 2022">{postDate}</time></p>
                </div>
            </div>
    </address>
    )
