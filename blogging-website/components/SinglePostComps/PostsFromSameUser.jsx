...
export default function PostsFromSameUser({id, date, content, profileUrl, username, title}) { // from the postId we can get poster
    ...
    return (
        <div className="w-fit px-8 py-4 mx-auto  rounded-lg shadow-md bg-gray-800 mt-10" key={id}>
            ...
            <div className="mt-2">
                ...
                <p className="line-clamp-2 overflow-ellipsis mt-2 text-gray-600 dark:text-gray-300">{content}</p>
            </div> 
            <div className="flex items-center justify-between mt-4">
                ...
                <div className="flex items-center">
                    <img src={profileUrl || "https://stackdiary.com/140x100.png"} alt="Author Photo" className=" object-cover w-5 h-5 mx-4 rounded-full sm:block" /> 
                    <span className="font-bold text-sm text-gray-700 cursor-pointer dark:text-gray-200">{username}</span>
                </div>
            </div>
        </div>
